...
//    private static final String redisHost = "192.168.1.220";
    ...
    public static class TestThread implements Runnable {
        ...
        public void actomicAdd() {
            ...
            while (flag) {
                cli.watch(incKeyStr);
                String countStr = cli.get(incKeyStr);
                ...
                //如果事务失败了exec会返回null
                if (list == null) {
                    System.out.println(Thread.currentThread()+" multi shut down");
                    continue;
                } else {
                    //如果达到期望值那么结束while循环
                    flag = false;
                }
                System.out.println(Thread.currentThread()+"my expect num is " + expect+" seting....");
            }
